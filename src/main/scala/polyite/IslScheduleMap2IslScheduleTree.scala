...
object IslScheduleMap2IslScheduleTree {
  protected def createTestConfig() : Option[Config] = {
    ...
    props.setProperty("measurementCommand", "/home/xluo/RL4Poly/polyite/measure_polybench.bash")
    props.setProperty("measurementWorkingDir", "/home/xluo/RL4Poly/polyite/")
    ...
    props.setProperty("irFilesLocation", "/home/xluo/RL4Poly/polyite/polybench-c-4.1")
    ...
    props.setProperty("barvinokBinary", "/home/xluo/RL4Poly/barvinok_binary/count_integer_points")
    props.setProperty("barvinokLibraryPath", "/home/xluo/RL4Poly/barvinok/build/lib")
